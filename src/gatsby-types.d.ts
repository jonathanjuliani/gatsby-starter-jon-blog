...
type SocialQueryQuery = { readonly site: { readonly siteMetadata: { readonly author: { readonly name: string | null, readonly summary: string | null } | null, readonly social: { readonly linkedin: string | null, readonly github: string | null } | null } | null } | null };
